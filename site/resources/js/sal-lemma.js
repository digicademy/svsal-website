...
document.body.addEventListener("click", async function (e) {
  ...
  if (t.matches("#toggleButton")) {
    ...
    t.matches(".dropdown-menu.export-options.dropdown.dropdown-toggle")
  ) {
    // export options: do not close menu on click
    console.log(
      `Stop event propagation for ${e}, possibly dropdown toolbox...`,
    );
    e.stopPropagation();
