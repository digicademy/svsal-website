...
listItemTemplate   :  '<% if (name == "Transcriptions") { %>' + '<div class="facetitem" id="<%= id %>"> <div class="facetitem_container">Reference Works <span class="facetitemcount">(<%= count %>)</span>  <div type="button" style="margin-left: 4px;" class="glyphicon glyphicon-info-sign" data-toggle="tooltip"  data-placement="right" title="Transcribed texts with technical editing only"></div></div></div>' + '<%} else if (name == "Editions") { %>' + '<div class="facetitem" id="<%= id %>"> <div class="facetitem_container"><%= name %> <span class="facetitemcount">(<%= count %>)</span>  <div type="button" style="margin-left: 4px;" class="glyphicon glyphicon-info-sign" data-toggle="tooltip"  data-placement="right" title="Fully edited texts"></div></div></div>' +    '<% } else if (name == "Automatic Editions") { %>' + '<div class="facetitem" id="<%= id %>"><div class="facetitem_container"><div class="facetitem_text"><%= name %> <span class="facetitemcount">(<%= count %>)</span> </div> <div type="button" style="margin-left: 4px;" class="glyphicon glyphicon-info-sign" data-toggle="tooltip"  data-placement="right" title="Transcribed works with technical editing only"></div></div></div>'  +'<% } else if (name == "Facsimiles") { %>' + '<div class="facetitem" id="<%= id %>"><div class="facetitem_container"><div class="facetitem_text"><%= name %> <span class="facetitemcount">(<%= count %>)</span> </div> <div type="button" style="margin-left: 4px;" class="glyphicon glyphicon-info-sign" data-toggle="tooltip"  data-placement="right" title="Image scans only; text is forthcoming"></div></div></div>' +'<% } else { %>' + '<div class="facetitem" id="<%= id %>"> <div class="facetitem_container"><%= name %> <span class="facetitemcount">(<%= count %>)</span> </div></div>' +'<% }%>',
