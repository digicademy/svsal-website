 ...
 */ !(function (a, b, c, d) {
  ...
  function f(b) {
    v &&
      (b.element.addClass("navbar-hidden").animate(
        {
      ...
      a(".dropdown.open .dropdown-toggle", b.element).dropdown("toggle"),
      (v = !1));
  }
  function g(a) {
    v ||
      (a.element.removeClass("navbar-hidden").animate(
        {
          top: 0,
        },
        {
  ...
  function h(a) {
    ...
    if (((t = b), 0 > c)) {
      ...
      if (!v)
        return void (a.settings.showOnBottom && b + u === o.height() && g(a));
      b >= l && f(a);
    }
  }
  function i(a) {
