  ...
  return (
    ...
    (this.inList = function (a, b) {
      ...
      for (var c = b, d = this.list.length; d > c; c++)
        if (
          this.list[c].fn === a ||
          (a.guid && this.list[c].fn.guid && a.guid === this.list[c].fn.guid)
        )
          return c;
      return -1;
    }),
              ...
              a.get(
                ...
                a.proxy(function (b) {
                  (e = a(this.itemsContainerSelector, b).eq(0)),
                    0 === e.length &&
                      (e = a(b).filter(this.itemsContainerSelector).eq(0)),
                    e &&
        ...
        return (
          c.done(function () {
            b.load(a, function (a, c) {
              b.render(c, function () {
                (b.nextUrl = b.getNextUrl(a)), b.resume(), b.scrollHandler();
              });
            });
          }),
          c.fail(function () {
...
var IASHistoryExtension = function (a) {
  return (
    ...
    (this.onScroll = function (a, b) {
      ...
      this.prevUrl &&
        ((a -= this.ias.$scrollContainer.height()), c >= a && this.prev());
    }),
    ...
    (this.getScrollThresholdFirstItem = function () {
      var a;
      return (
        (a = this.ias.getFirstItem()), 0 === a.length ? -1 : a.offset().top
      );
    }),
...
(IASTriggerExtension.prototype.bind = function (a) {
  ...
  (IASTriggerExtension.prototype.defaults = {
    ...
    htmlPrev:
      '<div class="ias-trigger ias-trigger-prev" style="text-align: center; cursor: pointer;"><p>&nbsp;</p><a>{text}</a></div>',
    offset: 0,
  }),
