...
const EMBEDDINGS_RERANK_CANDIDATE_LIMIT = 40
const EMBEDDINGS_RERANK_MODEL = 'Xenova/paraphrase-multilingual-MiniLM-L12-v2'
const EMBEDDINGS_RERANK_TIMEOUT_MS = 12000
const EMBEDDINGS_RERANK_MAX_QUERY_TOKENS = 320
const EMBEDDINGS_RERANK_MAX_DOC_TOKENS = 240
const EMBEDDINGS_RERANK_DOC_POOL_FACTOR = 1
const EMBEDDINGS_RERANK_TOP_SIGNALS = 15
