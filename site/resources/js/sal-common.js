...
function updateURLParameter(url, param, paramVal) {
  // from <https://stackoverflow.com/questions/1090948/change-url-parameters-and-specify-defaults-using-javascript#10997390>
  var TheAnchor = null;
...
jQuery("body").bind("click", function (e) {
  if (jQuery(e.target).closest(".navbar-collapse").length === 0) {
    // close collapsible navbar (small views)
...
$(document).ready(function () {
  ...
  $("#backTop").backTop({
    // put Back-to-top arrow in good position
    position: 100,
    speed: 200,
    color: "white",
  });
  if (typeof SyntaxHighlighter !== "undefined") {
    // enable syntax highlighting if loaded
