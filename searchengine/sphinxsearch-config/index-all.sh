...
find /var/data/existdb/data/export -type f -name "*.snippet.xml" -exec sed -i 's| xmlns:sphinx="http://www.salamanca.school/xquery/sphinx"||g' {} + >/etc/sphinxsearch/indexer.log 2>&1
